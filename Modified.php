	...
	<body>
		...
		<div class="container" style="left-padding: 20px;">
			<?php
				...
				// updates music
				$mod = "UPDATE musiclibrary.SHEET_MUSIC SET MusicID='$musid', TimePeriod='$period', Genre='$genre', Title='$title', YearComposed='$year', NumPresent='$copies', COMPFirst='$fname', COMPLast='$lname', Ensemble='$ensemble' WHERE MusicID='$musselect'";
				$result = mysql_query($mod);
				echo "MusicID $musid has been successfully updated!";
			?>

			<!-- Home Button -->
			<br></br><a href='Home.php'> Return to homepage</a><br></br>
		</div>
